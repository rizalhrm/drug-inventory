...
<?php
    ...
    $nama_supplier = $_POST['nama_supplier'];
		...
		header("Content-Disposition: attachment;Filename=Laporan-Detail-Pemesanan-$id_pemesanan-".date('F-Y', $date).".xls");
		echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=Windows-1252\">";
?>
        <table width="100%">
        <tr>
            <td align="left" colspan="3">
				<h3 align="center"><b>LAPORAN DETAIL PEMESANAN<br/>
        NO. <?php echo $id_pemesanan;?><br/>
